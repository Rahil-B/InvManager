 ...
 * @author RAHIL
 */
@WebServlet(name = "StorageAdminHistory", urlPatterns = {"/StorageAdmin/History"})
public class StorageAdminHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<Supplies> supplies_list =(List<Supplies>) sess.createCriteria(Supplies.class).add(Restrictions.gt("desId",0)).list();
...
//functional operation            
        ...
        if(redirection_string!=null)
            ...
            RequestDispatcher red=request.getRequestDispatcher("/templates/StorageAdmin/StorageAdminHistory.jsp");
