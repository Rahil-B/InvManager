 ...
 * @author RAHIL
 */
@WebServlet(name = "StorageAdminUpcomingSupply", urlPatterns = {"/StorageAdmin/UpcomingSupply"})
public class StorageAdminUpcomingSupply extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<Supplies> supplies_list =(List<Supplies>) sess.createCriteria(Supplies.class).add(Restrictions.eq("desId", warId)).add(Restrictions.ge("supplyDate", Date.valueOf(LocalDate.now() ) ) ).list();
...
//functional operation            
        ...
        RequestDispatcher red=request.getRequestDispatcher("/templates/StorageAdmin/StorageAdminUpcomingSupplies.jsp");
