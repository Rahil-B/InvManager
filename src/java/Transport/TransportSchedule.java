 ...
 * @author RAHIL
 */
@WebServlet(name = "TransportSchedule", urlPatterns = {"/Transport/TransportSchedule"})
public class TransportSchedule extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<Supplies> supplies_list =(List<Supplies>) sess.createCriteria(Supplies.class).add(Restrictions.gt("desId", 0)).add(Restrictions.ge("supplyDate", Date.valueOf(LocalDate.now() ) ) ).list();
...
//functional operation            
        ...
        if(redirection_string!=null)
         ...
         RequestDispatcher red=request.getRequestDispatcher("/templates/Transport/TransportSchedule.jsp");
