 ...
 * @author RAHIL
 */
@WebServlet(name = "TransportHistory", urlPatterns = {"/Transport/TransportHistory"})
public class TransportHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<Supplies> supplies_list =(List<Supplies>) sess.createCriteria(Supplies.class).add(Restrictions.ne("desId", -1)).list();
...
//functional operation            
        ...
        if(redirection_string!=null)
         ...
         RequestDispatcher red=request.getRequestDispatcher("/templates/Transport/TransportHistory.jsp");
