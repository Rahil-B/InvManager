 ...
 * @author RAHIL
 */
@WebServlet(name = "TransportHome", urlPatterns = {"/Transport/TransportHome"})
public class TransportHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<Supplies> supplies_list =(List<Supplies>) sess.createCriteria(Supplies.class).add(Restrictions.gt("desId", 0)).add(Restrictions.eq("supplyDate", Date.valueOf(LocalDate.now() ) ) ).list();
...
//functional operation            
        ...
        RequestDispatcher red=request.getRequestDispatcher("/templates/Transport/TransportHome.jsp");
