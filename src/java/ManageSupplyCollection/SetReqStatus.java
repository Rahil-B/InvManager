 ...
 */
package ManageSupplyCollection;
 ...
 * @author RAHIL
 */
@WebServlet(name = "SetReqStatus", urlPatterns = {"/ManageSupplies/SetReqStatus"})
public class SetReqStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int desId=Integer.parseInt(request.getParameter("warId"));
            Supplies sup = (Supplies)sess.get(Supplies.class, supId);
            sup.setDesId(desId);
            sess.update(sup);
            List<Inventory> inv_list =(List<Inventory>) sess.createCriteria(Inventory.class).add(Restrictions.eq("wareHouseId", warId)).add(Restrictions.eq("fruitId", sup.getFruitId())).list();
            ...
            redirection_string="/InvManager/StorageAdmin/Requests   ";
        }
